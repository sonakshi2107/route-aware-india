...
import { ArrowRight, Loader2, Mail, UserX, MapPin, Shield } from "lucide-react";
              ...
              <>
                <CardHeader className="text-center">
                  <div className="flex justify-center">
                    <div
                      className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mb-2 cursor-pointer"
                      onClick={() => navigate("/")}
                    >
